...
BOARD_KERNEL_CMDLINE := console=tty2 loglevel=7 androidboot.console=ttyHSL0 androidboot.hardware=qcom msm_rtb.filter=0x37 ehci-hcd.park=3 lpm_levels.sleep_disabled=1 earlyprintk=msm_hsl_uart,0xf991e000 utags.blkdev=/dev/block/platform/soc.0/f9824900.sdhci/by-name/utags utags.backup=/dev/block/platform/soc.0/f9824900.sdhci/by-name/utagsBackup boot_cpus=0-5 androidboot.selinux=permissive
...
# Vendor Init
TARGET_INIT_VENDOR_LIB := //$(DEVICE_PATH):libinit_clark
TARGET_RECOVERY_DEVICE_MODULES := //$(DEVICE_PATH):libinit_clark
